...
export const DisplayGraphQLQueryModal = ({
  ...
  return (
    ...
    >
      ...
      >
        <Dialog.Panel className="relative mx-auto flex h-full w-full flex-col overflow-y-hidden rounded bg-base-100 sm:w-11/12 md:w-5/6 lg:w-3/4 xl:w-2/3 2xl:w-1/2">
          <div className="sticky top-0 bg-base-100 pt-8 text-base-content shadow">
            <button
